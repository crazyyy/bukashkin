<?php /* Template Name: Home Page */ get_header(); ?>
  ...
  <div id="main_page">
      <img src="<?php echo get_template_directory_uri(); ?>/img/menu.png" width="524" height="517" alt="" class="menu" />
      <img src="<?php echo get_template_directory_uri(); ?>/img/slogan.png" width="451" height="80" alt="" class="slogan" />
