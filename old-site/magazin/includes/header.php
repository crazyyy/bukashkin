...
?>
<meta name="google-site-verification" content="4qYYtWksLoZhGjCR4gD85AoYi52IhtdN8W7vKNPzAok" />
</head>
<body><?php
  do_action ('body', '');	
...
$osTemplate->assign('1',' class="current"');
}
...
{
   $osTemplate->assign('2',' class="current"');
}

if (strstr($PHP_SELF, FILENAME_SHOPPING_CART)) 
{
   $osTemplate->assign('3',' class="current"');
}
...
{
   $osTemplate->assign('4',' class="current"');
}
...
if ( isset($_GET['coID']) && $_GET['coID']==12)  
{
  ...
  include(dir_path('includes').FILENAME_BANNER);
?>