...
if (function_exists('get_path') == false) header('Location: install');
...
// add the articles name to the breadcrumb trail
  if (isset($_GET['articles_id'])) {
    $article_query = osDBquery("select articles_name from " . TABLE_ARTICLES_DESCRIPTION . " where articles_id = '" . (int)$_GET['articles_id'] . "'");
