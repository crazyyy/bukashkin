...
if (dref_waction) 
{
		vlink = (typeof reformal_wdg_vlink != "undefined")  ? 'http://'+reformal_wdg_vlink : 'http://'+reformal_wdg_domain+'.reformal.ru/proj/?mod=one';
}
else
{
...
MyOtzivCl = function() {
    ...
    this.mo_showframe = function() {
        ...
        if (!dref_mode) {
            if ('left' == dref_align) {
                if (!dref_ext_img) {
                    ref_ud("<div class=\"furjbqy\"><table height=\"100%\"><tr><td valign=\"middle\"><a href=\""+vlink+"\""+((dref_waction)?' target=\"_blank\"':"")+"><img src=\""+siteAdr+"tmpl/images/transp.gif\" alt=\"\" style=\"border: 0;\" class=\"tdsfh\" /></a></td></tr></table></div>");
                } else { 
                ...
                if (!dref_ext_img)
                {
                    ref_ud("<div class=\"furrghtd\"><table height=\"100%\"><tr><td valign=\"middle\"><a href=\""+vlink+"\""+((dref_waction)?' target=\"_blank\"':"")+"><img src=\""+siteAdr+"tmpl/images/transp.gif\" alt=\"\" style=\"border: 0;\" class=\"tdsfh\" /></a></td></tr></table></div>");
                }
                else
                {
       ...
       ref_ud("<div class=\"fdsrrel\"><a href=\"http://reformal.ru\" target=\"_blank\"><img src=\""+siteAdr+"tmpl/images/widget_logo.jpg\" width=\"109\" height=\"23\" alt=\"\" border=\"0\" /></a></div>"+dref_title+"</div>");
