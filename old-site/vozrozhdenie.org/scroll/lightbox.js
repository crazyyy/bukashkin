...
//	Configuration
//
var fileLoadingImage = "scroll/images/loading.gif";		
var fileBottomNavCloseImage = "scroll/images/closelabel.gif";
...
Lightbox.prototype = {
	...
	updateDetails: function() {
		...
		if(imageArray.length > 1){
			...
			Element.setInnerHTML( 'numberDisplay', "‘ото " + eval(activeImage + 1) + " из " + imageArray.length);
		}
