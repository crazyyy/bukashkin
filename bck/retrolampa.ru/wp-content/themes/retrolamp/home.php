...
?>
			...
			<div id="slider" class="fon_alt">
                ...
                <div class="fixsed">
                    ...
                    <h3 class="title">Новые изделия<span></span><span></span></h3>
                    ...
                    <a class="all" href="/cs1 ">Посмотреть все работы</a>
            ...
            <div class="fon_alt">
                ...
                <div class="fixsed over">
					...
					?>
							...
							<div class="icon">
                        		<a class="icon_pic" href="<?=the_permalink();?>">
<?=get_the_post_thumbnail($post->ID, array(310,200));?>
            ...
            <div class="fixsed over">
                ...
                <?
					$args = array(
						'posts_per_page'   => 3,
						'offset'           => 0,
						'category'         => get_cat_ID( 'ЛампыСерия1' ),
						'orderby'          => 'post_date',
						'order'            => 'DESC',
						'post_type'        => 'post',
						'post_status'      => 'publish',
				...
				?>
                		<div class="icon">
                        	<a class="icon_pic" href="<?=the_permalink();?>"><?=get_the_post_thumbnail($post->ID, array(313,196));?></a>
                ...
                <a class="all" href="/cs1">Весь каталог</a>
