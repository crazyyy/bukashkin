...
<body>
        ...
        <div id="container">
             ...
             <header><div class="bghead"></div>
            
               <div class="tlt"> <div id="top_line"></div></div>
                
                <div class="fixsed">
                
                           
				<div style="float: right;margin: 25px 0 20px 20px;font-weight:bold;">Телефон: +7(926) 603-18-36</div>
                    <a id="logo" href="/"><img src="/wp-content/themes/retrolamp/images/logo_bg.png" /></a>
