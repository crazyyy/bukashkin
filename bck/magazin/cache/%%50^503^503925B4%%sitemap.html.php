<?php /* Smarty version 2.6.24, created on 2011-05-07 23:39:12
         compiled from shopos-light/module/sitemap.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'shopos-light/module/sitemap.html', 1, false),)), $this); ?>
<?php echo smarty_function_config_load(array('file' => ($this->_tpl_vars['language'])."/lang.conf",'section' => 'sitemap'), $this);?>

<table>
 <tr>
	<td class="heading3"><strong><?php echo $this->_config[0]['vars']['heading_sitemap']; ?>
</strong></td>
 </tr>
</table>
