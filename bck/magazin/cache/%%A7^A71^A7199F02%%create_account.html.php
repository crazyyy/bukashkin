<?php /* Smarty version 2.6.24, created on 2011-05-16 12:02:29
         compiled from shopos-light/module/create_account.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'config_load', 'shopos-light/module/create_account.html', 1, false),)), $this); ?>
...
</td>  </tr></table>  <table width="100%" border="0" cellspacing="0" cellpadding="0">        <tr>          <td class="main">&nbsp;</td>        </tr>		<tr>          <td class="main"><strong><?php echo $this->_config[0]['vars']['title_password']; ?>
</strong></td>        </tr>      </table>       <table class="formArea" width="100%" border="0" cellspacing="2" cellpadding="0">  <tr>           <td width="200" class="main"><?php echo $this->_config[0]['vars']['text_password']; ?>
</td>    <td class="inputRequirement"><?php echo $this->_tpl_vars['INPUT_PASSWORD']; ?>
</td>  </tr>  <tr>     <td class="main"><?php echo $this->_config[0]['vars']['text_confirmation']; ?>
</td>    <td class="inputRequirement"><?php echo $this->_tpl_vars['INPUT_CONFIRMATION']; ?>
