...
$db->query("INSERT INTO ".DB_PREFIX."configuration (configuration_key, configuration_value, configuration_group_id, sort_order, last_modified, date_added, use_function, set_function) VALUES ('VIS_BANNER', 'false',  30, 32, NULL, '', NULL, 'os_cfg_select_option(array(\'true\', \'false\'),')");
