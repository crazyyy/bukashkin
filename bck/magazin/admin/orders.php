...
?>
      ...
      <tr>
        <td class="main"><table border="1" cellspacing="2" cellpadding="5">
          <tr>
		...
		default :
			if (is_object($oInfo)) {
				...
				if (AFTERBUY_ACTIVATED == 'true') {
					$contents[] = array ('align' => 'center', 'text' => '<a class="button" href="'.os_href_link(FILENAME_ORDERS, os_get_all_get_params(array ('oID', 'action')).'oID='.$oInfo->orders_id.'&action=afterbuy_send').'"><span>'.BUTTON_AFTERBUY_SEND.'</span></a>');
