...
define('AFTERBUY_URL','You will find a detailed Afterbuy info here');
...
define('TEXT_LINK_FORUM_DESC' , 'URL for support forum at ShopOS.ru');
define('TEXT_LINK_CONTR_TITLE' , 'URL to the Contribution\'s page');
define('TEXT_LINK_CONTR_DESC' , 'URL for contrib\'s page at ShopoS.ru');
