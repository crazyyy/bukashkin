    ...
    function selection() {
      ...
      return array('id' => $this->code, 'icon' => $icon,
                         ...
                         'fields' => array(array('title' => MODULE_PAYMENT_WEBMONEYMERCHANT_TEXT_TYPE,
                                                 'field' => os_draw_pull_down_menu('wm', array(array('id' => 'wmr', 'text' => MODULE_PAYMENT_WEBMONEYMERCHANT_TEXT_WMR),array('id' => 'wmz', 'text' => MODULE_PAYMENT_WEBMONEYMERCHANT_TEXT_WMZ)),'wmr'))));
